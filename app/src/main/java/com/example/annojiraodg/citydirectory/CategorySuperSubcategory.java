...
public class CategorySuperSubcategory extends AppCompatActivity {
    ...
    String[] superSubCategoriesArray ={};
    EditText searchSubCategorytext;
    String subCategory;
    public String loadJSONFromAsset() {
        String json = null;
        try {
            InputStream is = this.getAssets().open("supersubcategories.json");
    ...
    private void initialise(String cat){
        ...
        try {
            ...
            subCategory = sharedpreferences.getString(SC,"");
            JSONArray jsonArray = jsonRootObject.optJSONArray(subCategory);
        ...
        superSubCategoriesArray = subCategoryArrayList.toArray(new String[subCategoryArrayList.size()]);
        ArrayAdapter adapter = new CustomSublistAdapter(this,superSubCategoriesArray);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                String Selecteditem= superSubCategoriesArray[+position];
                //Toast.makeText(getApplicationContext(),Selecteditem, Toast.LENGTH_SHORT).show();
                Intent i = new Intent(CategorySuperSubcategory.this, ClicktoCall.class);
...
//                return true;
    ...
    private void setLocationRedirect(){
        SharedPreferences.Editor editor = sharedpreferences.edit();
        editor.putString(PA, "CategorySuperSubcategory");
        editor.commit();
        Intent i = new Intent(CategorySuperSubcategory.this, MainActivity.class);
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(i);
    }
    ...
    public void onBackPressed() {
        ...
        editor.putString(PA, "CategorySuperSubcategory");
        editor.commit();
        Intent i = new Intent(CategorySuperSubcategory.this, CategorySubcategory.class);
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(i);
    }
